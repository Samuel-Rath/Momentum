  ...
  habits: [
    {
      ...
      frequency: 'daily', cadence: 'daily', expected: 30, completed: 22,
      total: 30, rate: 0.73, consistency: 0.81, trend: 0.05, score: 0.7, lastActive: 0,
      series: [0.6, 0.7, 0.5, 0.8, 0.7, 0.9, 0.6, 0.8, 0.75, 0.85, 0.7, 0.9],
    },
    {
      id: 2, name: 'Deep Work', category: 'productivity', color: '#8A6F3D', icon: '💻',
      frequency: 'daily', cadence: 'daily', expected: 30, completed: 25,
      total: 30, rate: 0.83, consistency: 0.88, trend: 0.1, score: 0.78, lastActive: 0,
      series: [0.7, 0.8, 0.85, 0.75, 0.9, 0.85, 0.95, 0.8, 0.9, 0.85, 0.95, 0.9],
    },
    {
      id: 3, name: 'Meditation', category: 'mindfulness', color: '#2C6E4F', icon: '🧘',
      frequency: 'weekly', cadence: 'weekly', expected: 5, completed: 3,
      total: 18, rate: 0.6, consistency: 0.65, trend: -0.12, score: 0.5, lastActive: 1,
